    ...
    >
      <div
        ...
        style={{
          position: "absolute",
          inset: 0,
          background: "radial-gradient(ellipse at 80% 50%, rgba(227, 6, 19,0.03) 0%, transparent 60%)",
          pointerEvents: "none",
        }}
      />
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* Body silhouette */}
              <ellipse cx="100" cy="78" rx="38" ry="44" fill="rgba(227, 6, 19,0.08)" />
              <ellipse cx="100" cy="78" rx="30" ry="36" fill="rgba(227, 6, 19,0.05)" />
              <path d="M28,260 Q40,160 100,140 Q160,160 172,260 Z" fill="rgba(227, 6, 19,0.06)" />
              {/* Neon accent lines */}
              <line x1="10" y1="240" x2="190" y2="240" stroke="rgba(227, 6, 19,0.15)" strokeWidth="1" />
              <line x1="10" y1="248" x2="120" y2="248" stroke="rgba(227, 6, 19,0.08)" strokeWidth="1" />
              {/* Monogram */}
              <text x="100" y="96" textAnchor="middle" fontFamily="Georgia,serif" fontSize="24" fontWeight="900" fill="rgba(227, 6, 19,0.3)">DA</text>
            </svg>
          </div>
        </motion.div>
