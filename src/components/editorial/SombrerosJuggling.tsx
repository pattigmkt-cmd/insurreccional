        ...
        <div className="relative" style={{ width: 220, height: 220 }}>
          ...
          >
            ...
            <div
              ...
              style={{ borderColor: "#e30613", background: "rgba(227, 6, 19,0.1)" }}
            />
          </div>
            ...
            return (
              <motion.button
                ...
                style={{
                  left: cx,
                  top: cy,
                  borderColor: isHovered ? "#e30613" : isDropped ? "#333" : "#444",
                  background: isDropped ? "#0a0a0a" : isHovered ? "rgba(227, 6, 19,0.15)" : "#111",
                }}
                animate={isDropped ? {
                  y: 80,
                  opacity: 0,
              ...
              >
                <span style={{ color: isHovered ? "#e30613" : "#888" }}>{role.icon}</span>
              </motion.button>
            );
          })}
        </div>
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          {ROLES.map((r) => (
            <span
              ...
              style={{
                color: droppedIds.includes(r.id) ? "#333" : hoveredId === r.id ? "#e30613" : "#555",
