    ...
    <div ref={ref} className="my-10 md:my-14">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div
          ...
          style={{ borderColor: "rgba(227, 6, 19,0.25)", background: "rgba(227, 6, 19,0.03)" }}
        >
          <p
          ...
          <p className="mb-5 font-serif text-sm italic" style={{ color: "#e30613", opacity: 0.7 }}>
          ...
          <div className="mb-6">
            <div className="mb-2 flex justify-between">
              ...
              <span className="font-mono text-[9px]" style={{ color: "#e30613" }}>
          ...
          <p className="mt-5 font-mono text-[9px] uppercase tracking-[0.2em]" style={{ color: "#e30613", opacity: 0.6 }}>
