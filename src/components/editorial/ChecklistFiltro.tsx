  ...
  return (
    ...
    >
      <rect
        ...
        height="18"
        rx="2"
        stroke={checked ? "#B00002" : "#333"}
        strokeWidth="1.5"
        fill={checked ? "rgba(176, 0, 2,0.08)" : "none"}
      />
      {checked && (
        <motion.path
          d="M5 10 L9 14 L15 7"
      ...
      <div className="space-y-3">
        {QUESTIONS.map((q, i) => (
          <motion.button
            ...
            style={checked[i] ? { borderColor: "rgba(176, 0, 2,0.25)", background: "rgba(176, 0, 2,0.03)" } : {}}
          ...
          >
            ...
            <span
              ...
              style={{ color: checked[i] ? "#B00002" : "#888" }}
            >
              {q}
            </span>
          </motion.button>
