...
export default function CompareEasterEgg() {
  ...
  const after = (
    ...
    >
      <svg viewBox="0 0 80 80" width="60" height="60" aria-hidden="true">
        <circle cx="40" cy="40" r="30" fill="none" stroke="rgba(200,255,0,0.3)" strokeWidth="1.5" />
        <circle cx="40" cy="40" r="20" fill="none" stroke="rgba(200,255,0,0.15)" strokeWidth="1" />
        <text x="40" y="47" textAnchor="middle" fontFamily="Georgia,serif" fontSize="18" fontStyle="italic" fill="rgba(200,255,0,0.4)">AB</text>
      </svg>
      <p
        style={{
          fontFamily: "var(--font-mono)",
